...
The city has become increasingly responsive to rat complaints. In 2016, the mayor's absolute goal for city workers is to respond to all relevant complaints within 5 days, and now it seems that this goal is largely achieved. The graph below shows how days to resolve complaints have dropped. Starting from 2016, the change becomes drastic.
```{r error=FALSE, fig.height=7., fig.width=11, message=FALSE, warning=FALSE}
chicago_rodents %>%
  ...
  labs(title = "Time to Resolve Rat Complaints Has Dropped over\nthe Past Few Years in Chicago (2014 to 2018)",
